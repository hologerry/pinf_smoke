def config_parser():
    ...
    # training options
    parser.add_argument("--net_model", type=str, default="nerf", help="which model to use, nerf, siren, hybrid..")
    ...
    parser.add_argument("--fix_seed", type=int, default=42, help="the random seed.")
    parser.add_argument(
        "--fading_layers",
        type=int,
        default=-1,
    ...
    parser.add_argument(
        "--train_warp", default=False, action="store_true", help="train radiance model with velocity warpping"
    )

    # model options
    parser.add_argument("--bbox_min", type=str, default="", help="use a boundingbox, the minXYZ")
    parser.add_argument("--bbox_max", type=str, default="1.0,1.0,1.0", help="use a boundingbox, the maxXYZ")

    # loss hyper params, negative values means to disable the loss terms
    parser.add_argument("--vgg_strides", type=int, default=4, help="vgg stride, should >= 2")
    parser.add_argument("--ghostW", type=float, default=-0.0, help="weight for the ghost density regularization")
    parser.add_argument("--vggW", type=float, default=-0.0, help="weight for the VGG loss")
    parser.add_argument("--overlayW", type=float, default=-0.0, help="weight for the overlay regularization")
    parser.add_argument("--d2vW", type=float, default=-0.0, help="weight for the d2v loss")
    parser.add_argument(
        "--nseW", type=float, default=0.001, help="velocity model, training weight for the physical equations"
    )
    ...
    parser.add_argument(
        "--half_res", type=str, default="normal", help="load blender synthetic data at 400x400 instead of 800x800"
    )
    ...
    parser.add_argument("--i_print", type=int, default=400, help="frequency of console printout and metric loggin")
