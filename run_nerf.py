...
def train(parser, args):
    ...
    if args.dataset_type == "llff":
        ...
        images, poses, render_poses, hwf, i_split = load_blender_data(
            args.datadir, args.half_res in ["True", "half"], args.testskip
        )
        ...
        if args.white_bkgd is not None:
            images = images[..., :3] * images[..., -1:] + (1.0 - images[..., -1:]) * args.white_bkgd
        else:
            images = images[..., :3]
        ...
        if i % args.i_video == 0 and i > 0:
            ...
            with torch.no_grad():
                rgbs, disps = render_path(
                    render_poses, hwf, K, args.chunk, render_kwargs_test, bkgd_color=args.white_bkgd
                )
...
if __name__ == "__main__":
    ...
    assert args.dataset_type != "pinf_data", "Please use run_pinf.py for pinf_data dataset."
    train(parser, args)
