...
class FixLayer(object):
    ...
    def get_variable(self, name, shape):
        ...
        if self._print:
            print(
                "[loading d2v variables]",
                name,
                shape,
                "get var %d" % self.var_idx,
                self.var_name[self.var_idx],
                test_var.shape,
            )
        self.var_idx += 1
        return test_var
...
class MyConvBlock(nn.Module):
    def __init__(
        ...
        self.conv_layer = fix_layer_tool._conv(ch_in, num_filters, name + ".CB", k_size, stride, is2D)
...
class MyDeconvBlock(nn.Module):
    def __init__(
        self, fix_layer_tool, ch_in, num_filters, name, k_size, stride, is2D=True, norm="instance", activation="relu"
    ):
        assert norm in ["instance", None]
        assert activation in ["relu", None]
        super(MyDeconvBlock, self).__init__()
        self.deconv_layer = fix_layer_tool._deconv(ch_in, num_filters, name + ".DCB", k_size, stride, is2D)
        self.norm_layer = None
        if norm is not None:
            if norm == "instance":
    ...
    def forward(self, input):
        ...
        if self.is2D:
            has_pad = _padding_size_2d(
                input.shape[-2] * self.stride, input.shape[-1] * self.stride, self.k_size, self.stride
            )
            out = out[:, :, has_pad[2] : out.shape[-2] - has_pad[3], has_pad[0] : out.shape[-1] - has_pad[1]]
        else:
            has_pad = _padding_size_3d(
                input.shape[-3] * self.stride,
                input.shape[-2] * self.stride,
                input.shape[-1] * self.stride,
                self.k_size,
                self.stride,
            )
            out = out[
                :,
                :,
                has_pad[4] : out.shape[-3] - has_pad[5],
                has_pad[2] : out.shape[-2] - has_pad[3],
...
class MyResBlock(nn.Module):
    def __init__(self, fix_layer_tool, num_filters, name, pad="reflect", is2D=True, norm="instance"):
        assert norm in ["instance", None]
...
class DenToVel(nn.Module):
    ...
    def build_param_layer(self, FLAGS):
        ...
        M1 = self.fix_layer_tool._fully_connected(param_n * 2, np.prod(mid_shape), "relu", name + "m1fc16")
        M2 = MyConvBlock(
            self.fix_layer_tool,
            mid_ch,
            mid_ch,
    ...
    def __init__(self, ckpt="./data/d2v_3Dmodel.npz", obsFlag=False, withZoom=False):
        ...
        namelist = [
            "generator/zoom_in/LS-8/w",
            "generator/zoom_in/LS-8/b",
            "generator/zoom_in/LS-out/w",
            "generator/zoom_in/LS-out/b",
            "generator/c7s1-32/w",
            "generator/c7s1-32/b",
            "generator/c7s1-32/instance_norm/shift",
            "generator/c7s1-32/instance_norm/scale",
            "generator/d64/w",
            "generator/d64/b",
            "generator/d64/instance_norm/shift",
            "generator/d64/instance_norm/scale",
            "generator/d128/w",
            "generator/d128/b",
            "generator/d128/instance_norm/shift",
            "generator/d128/instance_norm/scale",
            "generator/R128_0/res1/w",
            "generator/R128_0/res1/instance_norm/shift",
            "generator/R128_0/res1/instance_norm/scale",
            "generator/R128_0/res2/w",
            "generator/R128_0/res2/instance_norm/shift",
            "generator/R128_0/res2/instance_norm/scale",
            "generator/R128_1/res1/w",
            "generator/R128_1/res1/instance_norm/shift",
            "generator/R128_1/res1/instance_norm/scale",
            "generator/R128_1/res2/w",
            "generator/R128_1/res2/instance_norm/shift",
            "generator/R128_1/res2/instance_norm/scale",
            "generator/R128_2/res1/w",
            "generator/R128_2/res1/instance_norm/shift",
            "generator/R128_2/res1/instance_norm/scale",
            "generator/R128_2/res2/w",
            "generator/R128_2/res2/instance_norm/shift",
            "generator/R128_2/res2/instance_norm/scale",
            "generator/R128_3/res1/w",
            "generator/R128_3/res1/instance_norm/shift",
            "generator/R128_3/res1/instance_norm/scale",
            "generator/R128_3/res2/w",
            "generator/R128_3/res2/instance_norm/shift",
            "generator/R128_3/res2/instance_norm/scale",
            "generator/encPhy/d16c7/w",
            "generator/encPhy/d16c7/b",
            "generator/encPhy/d8/w",
            "generator/encPhy/d8/b",
            "generator/encPhy/d8/instance_norm/shift",
            "generator/encPhy/d8/instance_norm/scale",
            "generator/encPhy/d4/w",
            "generator/encPhy/d4/b",
            "generator/encPhy/d4/instance_norm/shift",
            "generator/encPhy/d4/instance_norm/scale",
            "generator/encPhy/d3s1-2/w",
            "generator/encPhy/d3s1-2/b",
            "generator/encPhy/d16c3/w",
            "generator/encPhy/d16c3/b",
            "generator/encPhy/m1fc2/fc",
            "generator/buildPhy/m1fc16/fc",
            "generator/buildPhy/d16/w",
            "generator/buildPhy/d16/b",
            "generator/buildPhy/energy-d2/w",
            "generator/buildPhy/energy-d2/b",
            "generator/buildPhy/energy-d1/w",
            "generator/buildPhy/energy-d1/b",
            "generator/R128_4/res1/w",
            "generator/R128_4/res1/instance_norm/shift",
            "generator/R128_4/res1/instance_norm/scale",
            "generator/R128_4/res2/w",
            "generator/R128_4/res2/instance_norm/shift",
            "generator/R128_4/res2/instance_norm/scale",
            "generator/R128_5/res1/w",
            "generator/R128_5/res1/instance_norm/shift",
            "generator/R128_5/res1/instance_norm/scale",
            "generator/R128_5/res2/w",
            "generator/R128_5/res2/instance_norm/shift",
            "generator/R128_5/res2/instance_norm/scale",
            "generator/vort_u32/w",
            "generator/vort_u32/b",
            "generator/vort_u32/instance_norm/shift",
            "generator/vort_u32/instance_norm/scale",
            "generator/vort_u16/w",
            "generator/vort_u16/b",
            "generator/vort_u16/instance_norm/shift",
            "generator/vort_u16/instance_norm/scale",
            "generator/vort_v1/w",
            "generator/vort_v1/b",
            "generator/vein_16/w",
            "generator/vein_16/b",
            "generator/vein_16/instance_norm/shift",
            "generator/vein_16/instance_norm/scale",
            "generator/vein_24/w",
            "generator/vein_24/b",
            "generator/vein_24/instance_norm/shift",
            "generator/vein_24/instance_norm/scale",
            "generator/vein_32/w",
            "generator/vein_32/b",
            "generator/vein_32/instance_norm/shift",
            "generator/vein_32/instance_norm/scale",
            "generator/u64/w",
            "generator/u64/b",
            "generator/u64/instance_norm/shift",
            "generator/u64/instance_norm/scale",
            "generator/u32/w",
            "generator/u32/b",
            "generator/u32/instance_norm/shift",
            "generator/u32/instance_norm/scale",
            "generator/c7s1-3/w",
            "generator/c7s1-3/b",
            "generator/zoom_out/HS-8/w",
            "generator/zoom_out/HS-8/b",
            "generator/zoom_out/HS-out/w",
            "generator/zoom_out/HS-out/b",
        ]
        if not withZoom:
            namelist = namelist[4:-4]
        ...
        self.Res_list = [
            MyResBlock(
                self.fix_layer_tool, res_ch, "R128_{}".format(i), pad="reflect", is2D=FLAGS.is2D, norm=self._norm
            )
        ...
        if FLAGS.useVortEnd:
            ...
            enc_vortEnd = MyConvBlock(
                self.fix_layer_tool,
                16,
                1 if FLAGS.is2D else 3,
                "vort_v1",
                7,
                1,
                pad="reflect",
            ...
            # ve_in = make_ve_in()
            vein_lvl2 = MyConvBlock(
                self.fix_layer_tool,
                2 if FLAGS.is2D else 6,
                16,
                "vein_16",
                7,
                1,
        ...
        Out1 = MyDeconvBlock(
            self.fix_layer_tool, res_ch, 64, "u64", 3, 2, is2D=FLAGS.is2D, norm=self._norm, activation=self._activation
        )
        Out2 = MyDeconvBlock(
            self.fix_layer_tool, 64, 32, "u32", 3, 2, is2D=FLAGS.is2D, norm=self._norm, activation=self._activation
        )
        out_ch = 1 if FLAGS.is2D else 3
        Out3 = MyConvBlock(
            self.fix_layer_tool, 32, out_ch, "c7s1-3", 7, 1, pad="reflect", is2D=FLAGS.is2D, norm=None, activation=None
        )
